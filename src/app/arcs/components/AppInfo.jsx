			...
			<div className="align-vertically block left-align">
				...
				<details>
					...
					<ul>
						...
						<li>Each Lars has a resource called Resource Power, it is used in the End of Chapter portion of the game to gain extra points for Lars that run behind. Use items (like the agents for example) on their player board to keep track of this.</li>
